        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex space-x-8">
              ...
              <Link href="/tutors" className="text-blue-600 font-medium">Find Tutors</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Find Expert Tutors in Malaysia
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Connect with qualified tutors for Mathematics, Science, English, and more.
            Personalized learning to help your child excel.
          </p>
        </div>
            ...
            {filteredTutors.map((tutor) => (
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm text-gray-600">
                  ...
                  <Link href="/auth/signup" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm">
                    Get Started
                  </Link>
                </div>
              </div>
            ...
            {selectedTutorData ? (
              <div className="bg-white rounded-lg shadow p-6 sticky top-6">
                ...
                <div className="space-y-4">
                  ...
                  {selectedTutorData.additional_notes && (
                    <div>
                      <h5 className="font-medium text-gray-900 mb-2">Additional Information</h5>
                      <p className="text-sm text-gray-600">{selectedTutorData.additional_notes}</p>
                    </div>
                  )}
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <Link href="/auth/signup" className="block w-full text-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium mb-2">
                      Sign Up to Contact
                    </Link>
                    <Link href="/auth/login" className="block w-full text-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium">
        ...
        <div className="mt-16 bg-blue-600 rounded-lg shadow-lg p-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Are You a Tutor? Join Our Platform!
          </h2>
          <p className="text-white opacity-90 mb-6 max-w-2xl mx-auto">
            Connect with students across Malaysia, manage your schedule, and grow your tutoring business with EduHome.my
          </p>
          <Link href="/auth/signup" className="inline-block px-6 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-gray-100">
            Register as Tutor
          </Link>
        </div>
      </div>
